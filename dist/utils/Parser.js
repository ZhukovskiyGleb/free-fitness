...
var Parser = /** @class */ (function () {
    ...
    Parser.parseMessage = function (msg) {
        ...
        return common ? __assign({}, common, { chatId: msg.chat.id, text: msg.text }) : undefined;
    };
    Parser.parseQuery = function (query) {
        var common = this.parseCommon(query);
        return common ? __assign({}, common, { chatId: query.message ? query.message.chat.id : 0, data: query.data }) : undefined;
    };
