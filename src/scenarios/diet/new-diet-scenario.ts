...
export class NewDietScenario extends Scenario {
    ...
    private getMealsAmountKeyboard(): InlineKeyboardButton[][] {
        return new KeyboardMaker()
        .addButton('3', DietScenarioUtils.LOSS_CALLBACK)
        .addButton('4', DietScenarioUtils.SUPPORT_CALLBACK)
        .addButton('5', DietScenarioUtils.GAIN_CALLBACK)
        .addButton('6', DietScenarioUtils.GAIN_CALLBACK)
        .result;
  }
